...
function mapJDToRecord(jd: typeof jobDescriptions.$inferSelect) {
  return {
    ...
    remote_work:           jd.remoteWork,
    salary_eur_min:        jd.salaryEurMin,
    salary_eur_max:        jd.salaryEurMax,
    years_experience_min:  jd.yearsExperienceMin,
    years_experience_max:  jd.yearsExperienceMax,
    industry:              jd.industry,
    language_requirements: jd.languageRequirements  ?? [],
    mobile_technologies:   jd.mobileTechnologies    ?? [],
    domain_keywords:       jd.domainKeywords        ?? [],
    work_permit_required:  jd.workPermitRequired,
    visa_sponsorship:      jd.visaSponsorship,
  }
}
