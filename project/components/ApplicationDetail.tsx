...
export default function ApplicationDetail({ applicationId }: Props) {
  ...
  return (
    <div className="p-5 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-md text-xs font-semibold bg-zinc-100 dark:bg-zinc-700 text-zinc-700 dark:text-zinc-200 hover:bg-zinc-200 dark:hover:bg-zinc-600 disabled:opacity-40 transition-colors"
          >
            {saving ? 'Saving…' : 'Save'}
          </button>
          {jdText && (
            <button
              onClick={extract}
              disabled={extracting}
              className="px-3 py-1.5 rounded-md text-xs font-semibold bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-40 transition-colors flex items-center gap-1.5"
            >
              {extracting ? (
                <>
      ...
      {extracted && (
        <div className="space-y-3 border-t border-zinc-100 dark:border-zinc-700/60 pt-4">
